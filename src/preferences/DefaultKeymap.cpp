...
KeyBind kFileMenu[] {
	...
	{ 1,"Export Project...",           'S', B_COMMAND_KEY | B_SHIFT_KEY,     0, 0,              FABER_EXPORT_PROJECT },
	{ 1,"Export Selection...",   'S', B_COMMAND_KEY | B_CONTROL_KEY, 'S', B_SHIFT_KEY,          FABER_EXPORT_SELECTION },

	{ 0, "", 0, 0, 0, 0, FABER_SPLITTER },

	{ 1,"Insert",              'I', B_COMMAND_KEY,            B_INSERT, B_SHIFT_KEY,            FABER_INSERT },
	{ 1,"Append",              0, 0,                                 0, 0,                      FABER_APPEND },
...
KeyBind kEditMenu[] {
    ...
    { 1,"Trim",               0, 0,                               0, 0,                         FABER_TRIM },
	{ 1,"Clear",              'B', B_COMMAND_KEY,            B_DELETE, 0,                       FABER_CLEAR },

	{ 0, "", 0, 0, 0, 0, FABER_SPLITTER },

	{ 1,"Preferences...",      'P', B_COMMAND_KEY,                 'P', B_SHIFT_KEY,            FABER_PREFERENCES },

	{ 0, NULL, 0, 0, 0, 0, FABER_EOF }
};

KeyBind kTracksMenu[] {
	{ 0, "Track", 0, 0, 0, 0, FABER_ITEM_START },

    { 1,"New Track",                  0, 0,                           0, 0,                     FABER_ITEM_START },

    { 1,"New Mono Track",             0, 0,                           0, 0,                     FABER_NEW_EMPTY_TRACK },
    { 1,"New Stereo Track",           0, 0,                           0, 0,                     FABER_NEW_EMPTY_TRACK },
